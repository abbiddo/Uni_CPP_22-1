...
#define BASE_ACCOUNT_ID 100              // 계좌번호는 100번부터 1000번 사이 랜덤으로 부여
...
private:
	inline bool authenticate(int id, string password);   // 인증 성공 : true(1), 인증 실패 : false(0)
...
public:
	...
	int getBalance() { return nBalance; } // 계좌 잔액 읽어오기
	string getAccountName() { return strAccountName; } // 고객명 읽어오기
};
